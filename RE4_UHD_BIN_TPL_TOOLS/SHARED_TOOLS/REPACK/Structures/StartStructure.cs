...
namespace SHARED_TOOLS.REPACK.Structures
{
    ...
    /// </summary>
    public readonly struct VColor : IEquatable<VColor>
    {
        ...
        public static bool operator ==(VColor lhs, VColor rhs) => lhs.Equals(rhs);

        public static bool operator !=(VColor lhs, VColor rhs) => !(lhs == rhs);

        public bool Equals(VColor obj)
        {
        ...
        public override bool Equals(object obj)
        {
            return obj is VColor o && o.A == A && o.R == R && o.G == G && o.B == B;
        }
    ...
    public struct StartVertex
    {
        ...
        public VColor Color;
        public FinalWeightMap WeightMap;
